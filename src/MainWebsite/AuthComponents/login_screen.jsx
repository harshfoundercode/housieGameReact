...
//     return (
//         <div className="min-h-screen bg-linear-to-br from-[#f0f4ff] to-white flex flex-col lg:flex-row">
            
//             {/* LEFT PANEL - Image (Hidden on mobile, visible on lg+) */}
//             <div className="hidden lg:block lg:w-112.5 xl:w-137.5 2xl:w-150 h-screen sticky top-0 overflow-hidden">
//                 <img
//                     src={tambolaLogo}
//                     alt="Tambola Login"
...
//                         <div className="w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-br from-[#004296] to-[#0066cc] rounded-2xl flex items-center justify-center shadow-lg">
...
//                             <span>🎥</span> What Our Users <span>🎥</span>
//                         </h3>
