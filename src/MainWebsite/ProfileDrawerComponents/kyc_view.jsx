    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <main className="grow flex items-center justify-center">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#004296] mx-auto"></div>
            <p className="mt-4 text-gray-500">Loading UPI ID details...</p>
          </div>
        </main>
        <Footer />
      </div>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <main className="grow pt-24 md:pt-28 pb-12 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h1 className="text-3xl md:text-4xl font-bold text-[#004296] mb-2">UPI ID Details</h1>
              <p className="text-gray-500 text-sm md:text-base">View your UPI ID verification status and details</p>
            </div>
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              <div className="text-6xl mb-4">📋</div>
              <p className="text-gray-500 mb-4">{error}</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                  <h3 className="text-lg font-semibold text-gray-800">UPI ID Status</h3>
                  <p className="text-gray-500 text-sm mt-1">Your verification status</p>
                </div>
                <div>
                  {getStatusBadge(kycData?.status)}
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  <p className="text-gray-500 text-sm">UPI ID</p>
                  <p className="font-medium text-gray-800 text-lg">{kycData?.upi_id || "-"}</p>
                </div>
              </div>
            </div>
