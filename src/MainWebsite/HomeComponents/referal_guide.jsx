...
//   const referralLink = referralCode ? `${API.REFERAL_URL}/ref/${referralCode}` : `${REFERAL_URL}/ref/${referralCode}`;
...
const ReferralGuide = () => {
  ...
  // ✅ FIXED: API.REFERAL_URL ki jagah API.UPLOAD_URL use karo
  const referralLink = referralCode ? `${API.REFERAL_URL}/ref/${referralCode}` : `${API.REFERAL_URL}/ref/${referralCode}`;
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <main className="grow pt-24 md:pt-28 pb-12 px-4 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500 mt-4">Loading referral details...</p>
          </div>
        </main>
        <Footer />
      </div>
