...
// ProfileDrawer.jsx - Updated version with edit functionality
import React, { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import { ROUTES } from "../../routes/routes";
import { API } from "../../services/api_url";
import { setLoggingOut } from "../../ServerError/api_interceptor";
import EditProfileModal from "../ProfileDrawerComponents/edit_profile"; // Import the modal
...
const ProfileDrawer = ({ isOpen, onClose }) => {
    ...
    // Handle profile update after edit
    ...
    // Modified handleMoreItemClick to handle both path and action
    const handleMoreItemClick = (item) => {
        if (item.action) {
            item.action(); // Execute action (like opening edit modal)
        } else if (item.path) {
    ...
    return (
        <>
            ...
            <EditProfileModal
                ...
                currentProfile={profileData || initialUserData}
