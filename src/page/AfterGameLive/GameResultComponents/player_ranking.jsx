...
//   if (!ticket) return { grid: [], flat: [], matched: [], matchedCount: 0, total: 0 };
...
//     // Remove duplicate tickets based on ticket_number
//     const seen = new Set();
//     const uniqueTickets = allTickets.filter(t => {
//       const key = t.ticket_number || t.ticket_id;
...
//       })
//       .sort((a, b) => {
//         // Primary: matchedCount (descending)
//         if (b.matchedCount !== a.matchedCount) {
//           return b.matchedCount - a.matchedCount;
//         }
//         // Secondary: total numbers (descending)
//         if (b.total !== a.total) {
//           return b.total - a.total;
//         }
//         // Tertiary: ticket_number (ascending)
//         return (a.ticket_number || 0) - (b.ticket_number || 0);
//       })
//       .slice(0, 10);
    
//     // Assign explicit ranks with unique keys
//     return ranked.map((item, index) => ({
//       ...item,
//       rank: index + 1,
//       _key: `rank-${index}-${item.ticket_number || item.ticket_id || index}`
//     }));
...
//                   return (
//                     <div key={item._key} className="pr-rank-card"
...
//                         animation: `pr-cardIn 0.4s ${(rank - 1) * 0.06}s both ease`,
//                       }}
//                     >
//                       {isTop3 && (
//                         <div style={{
...
//               {winnersArray.length > 0 ? `${winnersArray.length} WINNER${winnersArray.length > 1 ? "S" : ""} DECLARED` : "AWAITING WINNERS"}
//             </div>
//           </div>
