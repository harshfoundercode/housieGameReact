            ...
            {winnersArray.length === 0 ? (
              ...
              <div style={{
                ...
                {winnersArray.map((winner, idx) => {
                  console.log(`🎯 Rendering winner ${idx + 1}/${winnersArray.length}:`, winner);
                  ...
                  return (
                    <div
                      key={`winner-${winner.winner_id || idx}-${idx}`}
                      className="pr-winner-card"
                      onClick={() => {
                        console.log('📝 Opening ticket:', ticketForModal);
