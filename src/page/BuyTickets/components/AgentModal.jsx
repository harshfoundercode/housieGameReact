...
const AgentModal = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-sm">
      <div className="agent-modal bg-linear-to-br from-[#004296] to-[#002b66] rounded-2xl sm:rounded-3xl w-full max-w-[95%] sm:max-w-5xl max-h-[90vh] overflow-hidden border-2 border-[#FBEFA4]/50 shadow-2xl flex flex-col">
        {/* Modal Header - Fixed height, no flex shrink */}
        <div className="flex-shrink-0 bg-linear-to-r from-[#004296] to-[#003380] p-4 sm:p-6 border-b-2 border-[#FBEFA4]/50 z-10">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#FBEFA4] flex items-center gap-2 sm:gap-3">
                <span>📞</span> Our Agents
            ...
            <button
              ...
              className="w-8 h-8 sm:w-10 sm:h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-all flex-shrink-0"
            >
              <span className="text-lg sm:text-2xl">✕</span>
            </button>
          </div>
                  ...
                  >
                    <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="text-base sm:text-lg md:text-xl font-bold text-white truncate">{agent.name}</h3>
                        </div>

                        <div className="flex flex-wrap items-center gap-2 mt-2 sm:mt-3">
                          <span className="text-[0.625rem] sm:text-xs bg-white/10 px-2 py-1 rounded-full text-white/60 truncate">
                            📞 {agent.phone}
                          </span>
                          <span className="text-[0.625rem] sm:text-xs bg-green-500/20 px-2 py-1 rounded-full text-green-300 flex-shrink-0">
                            💬 WhatsApp
                          </span>
                        </div>
                      </div>

                      <div className="agent-actions flex flex-row sm:flex-col gap-2 w-full sm:w-auto mt-2 sm:mt-0 sm:flex-shrink-0">
                        <button
                          onClick={() => handleContactAgent(agent)}
                          className="flex-1 px-3 sm:px-4 py-2 rounded-xl font-semibold text-xs sm:text-sm flex items-center justify-center gap-1 sm:gap-2 bg-linear-to-r from-green-500 to-green-600 text-white hover:from-green-600 hover:to-green-700"
                        >
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="bg-linear-to-br from-white/10 to-white/5 rounded-xl p-4 sm:p-6 border border-[#FBEFA4]/30">
                <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 sm:gap-3 mb-2">
                      <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white truncate">{selectedAgent.name}</h3>
                    </div>
        ...
        {/* Modal Footer - Fixed height, no flex shrink */}
        <div className="flex-shrink-0 bg-linear-to-r from-[#004296] to-[#003380] p-3 sm:p-4 border-t border-[#FBEFA4]/30">
          <p className="text-center text-white/50 text-xs sm:text-sm">
            All agents are verified. Your privacy is protected.
          </p>
        </div>
